...
/**
 *  mtn-sme-2-data-order controller
 */
...
module.exports = createCoreController(
  ...
  ({ strapi }) => ({
    async create(ctx) {
      ...
      await strapi
        .service("api::mtn-sme-2-data-order.mtn-sme-2-data-order")
        .create(newOrder);
      ...
      try {
        ...
        if (res.status === 200 && res.data.status) {
          await strapi
            .query("api::mtn-sme-2-data-order.mtn-sme-2-data-order")
            .update({
              where: { ref: ref },
              data: {
                status: "delivered",
        ...
        // ) {
        //   await strapi.query("api::mtn-sme-2-data-order.mtn-sme-2-data-order").update({
        //     where: { request_Id: data.request_Id },
        //     data: {
        //       status: "qeued",
